...
if uploaded_file is not None:
    ...
    st.image(mask, caption="Predicted Mask", width='stretch', clamp=True)
    ...
    # --- Overlay visualization (improved) ---
    overlay = overlay_image_color(img, mask, color=(255,0,0), alpha=0.4)
